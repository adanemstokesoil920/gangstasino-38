...
function say(text,tone){commsEl.textContent=text;commsEl.classList.remove("st-comms-good","st-comms-bad");if(tone==="good"){commsEl.classList.add("st-comms-good-c42ca434");}
if(tone==="bad"){commsEl.classList.add("st-comms-bad-c42ca434");}}
...
function logFlight(value,won){var li=document.createElement("li");li.className="st-log-entry-c42ca434"+
